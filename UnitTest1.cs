...
{
    [TestFixture]
    public class ProvjeraRegistracijeNovogKorisnika
    {
        ...
        [Test]
        public void TheProvjeraRegistracijeNovogKorisnikaTest()
        {
            ...
            driver.FindElement(By.Id("LastName")).SendKeys("Milip");
            ...
            driver.FindElement(By.Id("Email")).SendKeys("cmrkilic@gmail.com");
